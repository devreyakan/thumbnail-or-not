...
== Short Description ==
A WordPress plugin that adds a "Thumbnail Status" column to the media library, indicating whether images are used as thumbnails.
...
== Support ==
If you have any issues or suggestions, please reach out through the [support forum](https://wordpress.org/support/plugin/thumbnail-or-not) or visit our [GitHub repository](https://github.com/devreyakan/thumbnail-or-not).
